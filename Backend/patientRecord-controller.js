...
exports.add_patientRecord = async function (req, res, next) {
    ...
    if (Nature_Of_Occupation == 0) {
        Nature_Of_Occupation = 'White-collar workers ';
        console.log('Nature_Of_Occupation :' + Nature_Of_Occupation);
    } else if (Nature_Of_Occupation == 1) {
        Nature_Of_Occupation = 'Farming, fishing, and forestry workers';
        console.log('Nature_Of_Occupation :' + Nature_Of_Occupation);
        ...
        Nature_Of_Occupation = 'Clarical workers';
        console.log('Nature_Of_Occupation :' + Nature_Of_Occupation);
        ...
        Nature_Of_Occupation = 'Workers not classfied by Occupation ';
        console.log('Nature_Of_Occupation :' + Nature_Of_Occupation);
    }
    ...
    if (Reason == 0) {
        ...
        Reason = 'Due to death parents/relations';
        console.log('Reason:' + Reason);
    } else if (Reason == 2) {
